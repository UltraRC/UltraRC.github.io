...
The overall goal of the system is to control the movement of the robots six legs, this requires powering and controlling 18 servo motors. At the core of the robots control system is an ESP32, a 32 bit microcontroller. Feature of this microcontroller which contributed to me choosing it consisted of the following.
