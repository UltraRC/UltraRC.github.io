...
The first task to complete was the design of the PCB. Using KiCad I re-drew the schematic shown in Figure 2.1. After that I chose all of the footprints for the components, opting for mostly through hole parts. In future I would prefer to use exclusively through hole parts. This is mostly due to the ease of PCB assembly and circuit debugging. A spreadsheet displaying links to purchase locations for all parts, along with their associated part quantities, footprints and prices was made. The hardware that  <a href="https://www.taydaelectronics.com/" target="_blank">Tayda Electronics</a> sells a variety of enclosures that are fit for housing guitar pedal projects. Their website also allows you to send dimensions for them to pre-drill holes in the enclosure for all of the off-board components (switches, jacks, on LED) before painting and shipping it to you
